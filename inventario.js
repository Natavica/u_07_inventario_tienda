...
// Tienes un array de productos de una tienda, cada uno con información sobre su 
// nombre, categoría, precio, cantidad en inventario y descuento. Tu tarea es trabajar 
// con este inventario utilizando programación funcional y estructuras de control.
// 1. Filtrar Productos con Descuento: Usa filter para obtener un nuevo array con 
// los productos que tienen un descuento aplicado (es decir, discount > 0).
...
const products = [
   ...
   const productosDescuento = products.filter(  products => products.discount > 0 );
    console.log(productosDescuento); //ejecutar para visualizar en la terminal con node inventario.js
